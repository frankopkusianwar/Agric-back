...
{
    const URL = '/api/v1/top-produce';
    const URL_FILTER = '/api/v1/top-produce/?start_date=2019-10-12&end_date=2020-12-12';
    protected $token;
    ...
    public function testShouldReturnTopFarmerProduce()
    {
        ...
        $this->assertArrayHasKey('farmProduceCount', $res_array);
        $this->assertArrayHasKey('topFarmProduce', $res_array);
        $this->assertArrayHasKey('allFarmProduce', $res_array);
    }

    public function testShouldReturnTopFarmerProduceByDate()
    {
